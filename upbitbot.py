...
def rsi(ticker, period: int = 14):
    data = pyupbit.get_ohlcv(ticker, interval='minute3', count = 20*180)
...
while True:
    ...
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_price < current_price and ma20 < current_price and now_rsi <= 26:
                krw = get_balance('KRW')
                if krw > 5000:
