...
def load_upbit(name):
    if name == 'aws':
        access = "CvFnCwIyggBX9GsIb3vx7ZD4a2MNx2gsGKOMTFHS" # Access key
        secret = "Nrhwb9839AWQda8Le94aPYj9EQgtnVsBZaXdTxyO" # Secret Key
